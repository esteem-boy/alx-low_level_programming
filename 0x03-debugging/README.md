Task #0: You are not coding the solution / function, you’re just testing it! However, you can adapt your function from 
	x01. C - Variables, if, else, while - Task #0 to compile with this main file to test locally.
